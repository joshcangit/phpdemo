...
define('MY_DATABASE', ''); // If specified, allows you to perform queries without `database.table` format.
...
$mysqli = mysqli_connect(MY_SERVER,MY_USERNAME,MY_PASSWORD,MY_DATABASE); // Database connection
